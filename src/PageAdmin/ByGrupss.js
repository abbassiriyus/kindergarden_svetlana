                    ...
                    <div className="modalAbbas">
                        ...
                        <select name="" id="select_5">
                            {this.state.employee.map(res => {
                                return <option value={res.employeeid}>{res.personfirstname} {res.personlastname} {res.personmiddlename} </option>
                            })}
                        </select><br />
                        ...
                        <button onClick={() => { this.closeModal() }} className='first_button'>Назад</button><button className='second_button' onClick={()=>{this.postTimeTable()}} >Сохранить</button>
                    </div></div>
...

                                {
                                    time.map(item => {
                                        return <tr className="btnadmp_tr1" >
                                            ...
                                            {weekday.map(item2 => {
                                                return <td className="btnadmp_td1">
