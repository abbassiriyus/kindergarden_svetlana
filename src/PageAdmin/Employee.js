        ...
        axios.post(`${url}/address`, formAdress).then(res => {
            ...
            axios.get(`${url}/address`).then(res1 => {
                ...
                axios.post(`${url}/person`, formData1).then(res2 => {
                    ...
                    axios.get(`${url}/person`).then(res => {
                        res.data.map(item => {
                            console.log(item.passportseries == document.querySelector(".form7").value, item.passportnumber == document.querySelector(".form8").value);
                            if (item.passportseries == document.querySelector(".form7").value && item.passportnumber == document.querySelector(".form8").value) {
                    ...
                    axios.delete(`${url}/employee/${item.employeeid}`).then(res => {
                        axios.delete(`${url}/person/${item.personid}`).then(res => {
                            axios.delete(`${url}/position/${item.positionid}`).then(res => {
                                axios.delete(`${url}/address/${this.state.deleteData.addressid}`).then(res => {
            ...
            <div className='body'>
                ...
                <div className="modal11">
                    <ul className="tabs11">
                        ...
                        <li className="lipage3" onClick={() => { this.openPageNumber(3) }} >Информация о работе</li>
                    </ul>
                    ...
                    <div className='Apages3'>
                        ...
                        <div className="df_button">
                            ...
                            <button className='df_button2' onClick={() => { this.postEmployee() }}>Сохранить</button>
                        </div>
                    </div>
                ...
                <div id='tables'>
                    ...
                    {this.state.data.map((item, key) => {
                      ...
                      <div id='inform-p'>
                                    ...
                                    <p className='itemPrsnLst'>{item.dateofbirth.slice(0, 10)}</p>
