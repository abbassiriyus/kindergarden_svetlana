...
import imgg from "../img/image 29.png";

export default class Form extends Component {
  modalOpen() {
    document.querySelector("#Modal").style =
      "display: block;margin-left: -5% !important;";
  ...
  getMail = () => {
    if (
      document.querySelector("#name_post").value === "superAdmin" &&
      document.querySelector("#password_post").value === "parol"
    ) {
    ...
    data.append(
      "passportnumber",
      document.querySelector("#password_post").value
    );
    ...
    axios
      ...
      .then((res) => {
        ...
        localStorage.setItem(
          "name",
          document.querySelector("#name_post").value
        );
        window.location = "/";
        ...
        <div className="Big-Form">
          <div className="Div-form">
            ...
            <div className="Inp-form">
              <input id="name_post" placeholder="Логин" type="text" />
              <br />
              <input placeholder="Пароль" id="password_post" type="password" />
              <br />
