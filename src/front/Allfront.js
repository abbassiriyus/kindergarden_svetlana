  ...
  return (
    <div className='BigHome'>
      <div className="Navbar">
          <div className="Logo">
              <p onClick={()=>ToPage()}><img src={Logo} alt=""/></p>
          </div>
          ...
          <div className="linksNav">
               <span className='dropdown'>
                  <p onMouseEnter={selectOpen1} onMouseLeave={selectClose1}
                     className="labelSelect">О нас  <br/> <IoIosArrowDown/></p>
                  <div onMouseEnter={selectOpen1} onMouseLeave={selectClose1} className="selectNav1 ">
              ...
              <span className='dropdown'>
                  <div onMouseEnter={selectOpen2} onMouseLeave={selectClose2} className="selectNav2">
              ...
              <div onClick={enterOpen} className="btnEnter">Войти</div>

              <div className="modalEnter">
                  <h2>Вход для</h2>
                  <a href='form'>Для сотрудников</a>
                  <a href="number">Для родителей</a>
                  <div onClick={closeModal} className="closeModal">Закрыть</div>
              </div>
          </div>
          ...
          <div className="ContactsNav">
              ...
              <div className="NumberNav">
                  <a href="#"><span><img src={telephone} alt=""/></span>+7 (8452) 57 79 35</a>
          ...
          <div className="BelowMap">
              <div className="leftContent">
                  ...
                  <div className="contactsFooter">
                      <div className="numberFooter">
                          <a className='ahref' href="#"><span><img src={telephone} alt=""/></span> <h1 className='pulsyet'> +7 (8452) 57 79 35</h1></a>
                          <a href="#">wizardschool@mail.ru</a>
                      </div>

                      <p> Саратов, ул. Пугачева д.98/100
                          <br/>
                      ...
                      <span>
                              Copyrights: Школа Волшебников 2023
                          </span>
                  </div>
              </div>
              <div className="RightContent">
                <div className="linksFooter">
                    ...
                    <ul>
                        <li><h2>Расписание</h2></li>
                        <li><a href="#">Расписание основное</a></li>
                        <li><a href="#">Расписание доп. занятий</a></li>
                    </ul>
                    <ul>
                        <li><h2>Программа</h2></li>
                    </ul>
                    <ul>
                        <li><h2>Новости</h2></li>
                    </ul>
